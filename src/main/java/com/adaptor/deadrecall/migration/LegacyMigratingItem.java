...
/**
 * Decode-safe placeholder for a legacy item ID.
 *
 * <p>The first supported interaction replaces the held stack with its
 * canonical item while preserving the complete component patch, then delegates
 * the same interaction to the canonical item.</p>
 */
final class LegacyMigratingItem extends Item {
    LegacyMigratingItem(Properties properties) {
        super(properties);
    }
