...
| [TotemLocksmith](https://github.com/Yunitrish006006/TotemLocksmith) | `0.1.0` | Fixed-container network locks, permissions, keys, and audits |
...
| [TotemVillagers](https://github.com/Yunitrish006006/TotemVillagers) | `0.1.30` | Villager inventory, work, economy, rendering, and world generation |
...
2. Place `deadrecall-2.4.19-bundled.jar` in `mods/` on both client and server.
