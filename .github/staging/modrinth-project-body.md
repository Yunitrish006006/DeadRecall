...
- It ships the exact ten-module combination in one Fabric nested-JAR bundle.
...
- The last successfully used Nexus interface can remain soulbound through death, without bypassing normal travel cost or safety checks.
...
| Goal | What to do |
| --- | --- |
| Read the integrated guide | Obtain any Totem-series tutorial book; participating chapters combine into the Totem Manual. |
| Open a backpack | Hold it and right-click. Capacity modules expand its usable storage. |
| See the backpack beside inventory | Keep a backpack available, then open the normal player inventory. |
...
| --- | ---: | --- |
| [TotemCore](https://github.com/Yunitrish006006/TotemCore) | `0.5.0` | Shared API, manual, events, migrations, and version handshake |
| [TotemRemnant](https://github.com/Yunitrish006006/TotemRemnant) | `0.2.10` | Backpacks, modules, death recovery, and container safety |
| [TotemAutomata](https://github.com/Yunitrish006006/TotemAutomata) | `0.1.11` | Copper Golem sorting, routing, and collection |
| [TotemNexus](https://github.com/Yunitrish006006/TotemNexus) | `0.2.5` | Space Units, friends, travel, and death destinations |
| [TotemDiscordBridge](https://github.com/Yunitrish006006/TotemDiscordBridge) | `0.1.5` | Minecraft events and Discord delivery |
| [TotemAlchemy](https://github.com/Yunitrish006006/TotemAlchemy) | `0.1.22` | Dynamic alchemy, ingredient research, and cauldron content |
...
| [TotemVanillaTweaks](https://github.com/Yunitrish006006/TotemVanillaTweaks) | `0.1.7` | Recipes, sorting, and vanilla-compatible adjustments |
| [TotemVillagers](https://github.com/Yunitrish006006/TotemVillagers) | `0.1.22` | Villager inventory, work, economy, rendering, and world generation |
...
3. Do **not** add standalone copies of the ten embedded Totem modules.
