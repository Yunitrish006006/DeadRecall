...
- [x] 13.7 重啟、區塊卸載與資料恢復測試。
  ...
  - [x] 真實 chunk unload／reload 保留 Entity UUID、Home、target、activity、fuel、工具、倉庫 Components 與 scanner cursor。
  - [x] 三次獨立 Dedicated Server JVM `seed → recover → verify` world persistence probe。
  - [x] 詳細證據見 [`13.7-persistence-evidence.md`](13.7-persistence-evidence.md)。
